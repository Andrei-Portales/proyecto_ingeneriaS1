...
import Ruler2 from "../../../../assets/ruler2.svg";
...
const Exercise10000 = (props) => {
  ...
  const nextExercise = () => {
    history.push(`/grados/cuarto/matematicas`);
  };
  ...
  return (
    <div className="exerciceWrapper">
      ...
      <div className="panel">
        ...
        {correct ? <SuccessBanner /> : <ProgressBar steps={8} index={8} />}
        <ProfileAvatar />
      </div>
