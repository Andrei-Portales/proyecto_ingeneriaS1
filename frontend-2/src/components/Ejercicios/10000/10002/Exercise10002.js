...
const Exercise10000 = (props) => {
  ...
  const radio_label = `${
    correct ? "radio_label pointerEvents" : "radio_label"
  }`;
          ...
          <div className="problemContent">
            <div className="problemContentTextBlock">
              ...
              <div className="problemContentText">
                ...
                <br />
                <br />
                <b>ciento treinta y dos mil doscientos cincuenta y tres</b>
                <br />
                <br />
                <br />
