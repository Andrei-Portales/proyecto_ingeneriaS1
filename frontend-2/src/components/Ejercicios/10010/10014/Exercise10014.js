...
import "./exercise-10014.scss";
import Shuttle from "../../../../assets/shuttle.png";
import AnguloRecto2 from "../../../../assets/AnguloRecto2.svg";
  ...
  return (
    <div className="exerciceWrapper">
      ...
      <div className="panel">
        ...
        {correct ? <SuccessBanner /> : <ProgressBar steps={8} index={4} />}
        <ProfileAvatar />
      </div>
          ...
          <div className="problemContent">
            <div className="problemContentTextBlock">
              ...
              <div className="problemContentText">
                ¿cuántas veces cabe el ángulo recto?
                <br />
                {/* <br /> */}
                <img src={AnguloRecto2} height="370" alt="Ruler" />
                {/* <br />
                <br />
                <br /> */}
