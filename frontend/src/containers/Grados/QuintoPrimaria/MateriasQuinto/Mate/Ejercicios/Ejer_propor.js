...
import Ejer2 from '../../../../../images/Ejer2_propor.png';
import Ejer1 from '../../../../../images/Ejer1_propor.png';
  ...
  return (
    <Container fluid className="grades-container">
      <PDFExport
        ...
        paperSize="auto"
        margin={40}
        fileName={`Proporciones Quinto Primaria`}
        creator="Educa Facil"
