...
import Ejer2 from '../../../../../images/Ejer2_reinos.png';
import Ejer1 from '../../../../../images/Ejer1_reinos.png';
  ...
  return (
    <Container fluid className="grades-container">
      <PDFExport
        ...
        paperSize="auto"
        margin={40}
        fileName={`Ejercicios Reinos Sexto Primaria`}
        creator="Educa Facil"
