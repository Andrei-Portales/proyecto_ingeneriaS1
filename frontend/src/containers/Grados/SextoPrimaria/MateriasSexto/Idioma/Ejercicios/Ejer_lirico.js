...
import Ejer2 from '../../../../../images/Ejer2_lirico.png';
import Ejer1 from '../../../../../images/Ejer1_lirico.png';
  ...
  return (
    <Container fluid className="grades-container">
      <PDFExport
        ...
        paperSize="auto"
        margin={40}
        fileName={`Lirico Sexto Primaria`}
        creator="Educa Facil"
