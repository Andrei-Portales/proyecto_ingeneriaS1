...
import Ejer2 from '../../../../../images/Ejer2_semantica.png';
import Ejer1 from '../../../../../images/Ejer1_semantica.png';
  ...
  return (
    <Container fluid className="grades-container">
      <PDFExport
        ...
        paperSize="auto"
        margin={40}
        fileName={`Semantica Sexto Primaria`}
        creator="Educa Facil"
